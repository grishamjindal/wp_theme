<?php if(! function_exists ('stylumia_setup') ) :

    function stylumia_setup() {
...
add_action('after_setup_theme', 'stylumia_setup');


/* ---- Add Stylesheets ---- */

function stylumia_scripts() {
    ...
    wp_enqueue_style('stylumia_styles', get_stylesheet_uri() );

    wp_enqueue_script('jquery', get_template_directory_uri().'/js/jquery.min.js' );
    wp_enqueue_script('isotope', get_template_directory_uri().'/js/jquery.isotope.min.js', array('jquery'),  true );
    wp_enqueue_script('image_loaded', get_template_directory_uri().'/js/images-loaded.js', array('jquery'),  true );
    wp_enqueue_script('infinite_scroll', get_template_directory_uri().'/js/infinite-scroll.min.js', array('jquery'),  true );
    wp_enqueue_script('isotope_masonary', get_template_directory_uri().'/js/isotope-masonry.js', array('jquery', 'isotope', 'image_loaded'),  true );
    wp_enqueue_script('my_script', get_template_directory_uri().'/js/my-script.js', array('jquery', 'infinite_scroll','isotope', 'image_loaded'),  true );
    wp_enqueue_script('on_scroll_transitions', get_template_directory_uri().'/js/onScroll.js', array('jquery'),  true );
}
add_action('wp_enqueue_scripts', 'stylumia_scripts');


/* ---- Register Widget  Area ---- */
function stylumia_widget_init() {
    register_sidebar( array(
        'name' => __( 'Main Sidebar', 'Stylumia'),
        'id' => 'main-sidebar',
        'description' => __('Widget added here will appear in all Blog posts.', 'Stylumia'),
...
add_action('widgets_init', 'stylumia_widget_init');
